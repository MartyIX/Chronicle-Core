...
java -version
mvn -Dmaven.compiler.fork=true -Dmaven.javadoc.skip=true -Dmaven.compiler.executable=/home/marty/work/programs/jdk-9-ea/bin/javac clean install dependency:copy-dependencies
